<template>
  <div id="auth">
    <form method="post" @submit.prevent="login">
      <label for="avatar">
        <svg v-show="!avatar" version="1.1" id="Capa_1" x="0px" y="0px"
          ...
          <g>
            <g>
              ...
              <path d="M446.8,383.6c0-0.1,0-0.2,0-0.3c0-0.8-0.1-1.6-0.1-2.5c-0.6-19.8-1.9-66.1-45.3-80.9c-0.3-0.1-0.7-0.2-1-0.3
                ...
                C447,415.5,446.9,388.8,446.8,383.6z"/></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g>
          </svg>
          <div v-show="avatar" class="avatar"></div>
        <input @change="addAvatar" type="file" name="avatar" id="avatar"  style="display:none" ref="avatar">
      </label>
      <label for="name">
        ФИО
...
export default {
  ...
  watch: {
    departament(){
     this.isShow = this.departament.length > 0 ? true : false
    }
  },
  computed: {
    ...mapGetters(['departaments']),
    allDepartaments(){
      return this.departaments.filter(departament=>departament.name.toLowerCase().includes(this.departament.toLowerCase()))
    }
  },
  methods: {
